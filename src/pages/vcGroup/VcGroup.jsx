  ...
  const features = [
    {
      ...
      image: 'https://images.pexels.com/photos/4327224/pexels-photo-4327224.jpeg?auto=compress&cs=tinysrgb&w=800',
    ...
    },
    {
      ...
      description: 'Special focus on start-ups founded by student athletes.',
  ...
  return (
    <div className="bg-black text-gray-200">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://images.pexels.com/photos/3182814/pexels-photo-3182814.jpeg?auto=compress&cs=tinysrgb&w=1600')",
        }}
      >
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">
            Athlete-Focused <span className="text-orange-500">Venture Capital</span>
          </h1>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://images.pexels.com/photos/3184301/pexels-photo-3184301.jpeg?auto=compress&cs=tinysrgb&w=1600')",
        }}
      >
